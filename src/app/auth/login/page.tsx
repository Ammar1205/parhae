...
export default function LoginPage() {
  ...
  const { signInEmail, signInWithGoogle, user, loading } = useAuth();
    ...
    <div className="w-full max-w-md mx-auto p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="font-fredoka text-3xl font-bold text-slate-800">Welcome Back</h1>
          <p className="text-slate-500 font-quicksand mt-2">Sign in to your Parhae Likhae account</p>
        </div>
        ...
        <form onSubmit={handleEmailLogin} className="space-y-4">
          ...
          <div className="flex justify-end">
            <a href="#" className="text-xs font-semibold text-emerald-600 hover:text-emerald-700 font-quicksand">
              Forgot password?
            </a>
          </div>
          ...
          <motion.button
            ...
            type="submit"
            disabled={isLoading}
            className="w-full py-3.5 bg-gradient-to-r from-emerald-500 to-teal-500 text-white font-bold rounded-xl font-quicksand shadow-lg shadow-emerald-200 disabled:opacity-70 disabled:cursor-not-allowed transition-shadow hover:shadow-xl hover:shadow-emerald-300"
          >
